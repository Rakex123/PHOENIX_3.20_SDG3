...
Based on your analysis, perform the following tasks and generate a JSON output that conforms to the provided schema.

1.  **Analyze the Journal Entry**:
    *   **sentiment**: Determine the overall emotional sentiment ('Positive', 'Neutral', 'Negative').
    *   **emotions**: Identify the dominant emotions expressed. Choose from: 'happiness', 'stress', 'anxiety', 'sadness', 'anger', 'loneliness', 'hope', 'exhaustion'. This should be a comma-separated string.
    ...
    *   **riskLevel**: Based on the score, determine the corresponding risk level ('Emotionally stable', 'Mild distress', 'High distress', 'Critical distress').
    These fields should be in the \`internalAnalysis\` object.
...
2.  **Generate a Student Response**:
    ...
    *   Do NOT encourage or validate self-harm.
